                    ...
                    <div className="section-card-bg rounded-2xl shadow-lg p-8" style={{ boxShadow: '0 0 40px 0 #430A48, 0 0 80px 0 #430A48' }}>
                        ...
                        <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-12">
                            <img
                                ...
                                alt="Tuku Ternak Logo"
                                className="w-24 h-24 object-contain"
                            />
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">Tuku Ternak</h1>
                                <p className="text-muted-foreground text-lg mb-4">
                                    Animal Husbandry E-commerce Platform
                                </p>
                        ...
                        <div className="grid md:grid-cols-3 gap-8 mb-12">
                            <div className="md:col-span-2">
                                ...
                                <p className="text-muted-foreground mb-6 leading-relaxed">
                                    Tuku Ternak is an innovative e-commerce application focused on animal husbandry,
                                    designed to empower breeders and MSMEs (Micro, Small, and Medium Enterprises)
                                    in the livestock industry. The platform facilitates the buying and selling of
                                    various livestock products while implementing sustainable business concepts.
                                </p>
                                <p className="text-muted-foreground mb-6 leading-relaxed">
                                    The project addresses the unique challenges faced by the livestock industry,
                                    providing a comprehensive solution that connects buyers and sellers in a
                                    trusted, efficient marketplace. The platform includes features for product
                                    management, secure transactions, and community building among industry stakeholders.
                                </p>
                            </div>
                            <div>
