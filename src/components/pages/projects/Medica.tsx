                ...
                >
                    ...
                    <div className="section-card-bg rounded-2xl shadow-lg p-8" style={{ boxShadow: '0 0 40px 0 #430A48, 0 0 80px 0 #430A48' }}>
                        <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-12">
                            ...
                            />
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-4">Medica</h1>
                                <p className="text-muted-foreground text-lg mb-4">
                                    Room Disinfection & Decontamination Services
                                </p>
                        ...
                        <div className="grid md:grid-cols-3 gap-8 mb-12">
                            <div className="md:col-span-2">
                                ...
                                <p className="text-muted-foreground mb-6 leading-relaxed">
                                    Medica is a web design project for commercial and residential room disinfection and decontamination services. The platform highlights international standard products that eliminate 99.999% of bacteria, viruses, and spores.
                                </p>
                                <p className="text-muted-foreground mb-6 leading-relaxed">
                                    The project focuses on providing a clean, informative, and trustworthy web presence for a health-focused business.
                                </p>
                            </div>
                            <div>
